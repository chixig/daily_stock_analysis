...
补52笔，先核验按日期历史成交通道，等待探测。

## B18 当前研究
2026-09-26用户将纠偏后的方向交本执行任务。范围：有限卖出因子与双条件、13回补路径、2020—2023发现及2024后历史复核，同资源1000股足额资金账户。数据截至2026-09-11。仅在B18独立研究分支计算和保存；无策略采用或交易。

## B18 已提交研究结论（2026-09-26）
166条件×13回补=2158组合；前段预选未稳健超旧单批。有限补充的全历史事后线索H00：154笔、47.40%、+23052.32元；H01：41笔、75.61%、+14614.97元；H03同条件直接开盘：41笔、60.98%、+13874.46元。统一3000股资源下旧单批+10014.41元，原1000股B17账户+11271.41元已复现。成本5/11/20bp、FIFO股息税及终端准备入账；共13完整路径/39成本账户。结论submitted，未采用：H00收益优先，H01胜率优先，H03简洁/历史尾部取舍优先复核。早期表现弱、后段事后筛选、细数据只覆盖H00 13/154和H01 4/41；不称独立OOS成功。固定结果/验证与报告见research/foxconn_t0_20260926_b18/REPORT.md。
