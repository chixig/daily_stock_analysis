...
## Foxconn batch03
User requested a final bounded factor round before deciding whether to discontinue the literal open-sell close-buy approach. Validation pending. Specification FOXCONN_T0_B03.md; no actual trading.
