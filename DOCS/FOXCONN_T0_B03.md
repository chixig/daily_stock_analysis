# Foxconn T0 batch03
Status active. User requested one detailed factor round, comparable positive-T evidence, and attribution of declines into overnight and intraday components. No market data processing locally. No rule tuning after results.
